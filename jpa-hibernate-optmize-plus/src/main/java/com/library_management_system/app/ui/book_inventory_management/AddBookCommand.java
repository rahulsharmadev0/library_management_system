...
@Route(title = "Add New Book", description = "Add a new book to the library inventory")
    ...
    protected void performAction() {
        ...
        Input.get()
                ...
                .execute((inputs) -> {
                    ...
                    showMessage("Book '" + inputs[0].toString() + "' has been successfully added to the library!",
                            false);
                });
